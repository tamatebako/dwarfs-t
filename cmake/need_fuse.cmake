...
if(WIN32)
  ...
  if(APPLE)
    ...
    elseif(FUSE_FOUND)
      ...
      message(FATAL_ERROR "No FUSE or FUSE3 library found. Install FUSE development packages for FUSE driver support (in vcpkg builds, enable the opt-in 'fuse' manifest feature: -DVCPKG_MANIFEST_FEATURES=fuse). Set DWARFS_WITH_FUSE=OFF to disable FUSE support.")
    endif()
  endif()
endif()
